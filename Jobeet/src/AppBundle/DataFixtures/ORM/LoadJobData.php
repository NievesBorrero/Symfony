...
class LoadJobData extends Fixture
{
  public function load(ObjectManager $em)
  {
    ...
    $job_sensio_labs->setExpiresAt(new \DateTime('2012-10-10'));
     ...
     $job_sensio_labs->setUpdatedAt(new \DateTime('2012-10-10'));
    ...
    $job_extreme_sensio->setUpdatedAt(new \DateTime('2012-10-10'));
    ...
    $job_expired->setUpdatedAt(new \DateTime('2005-12-01'));
    ...
    for($i = 100; $i <= 130; $i++)
  {
    ...
    $job->setCreatedAt(new \DateTime('2012-10-10'));
    $job->setUpdatedAt(new \DateTime('2012-10-10'));
