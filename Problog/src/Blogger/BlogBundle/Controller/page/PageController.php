...
class PageController extends Controller
{
   ...
   public function contactAction(Request $request){
        ...
        return $this->render('@BloggerBlog/contact.html.twig',array('form'=>$form->createView())); 
        // A la vista le estoy pasando el formulario, los datos en un array que los va a ir rellenando
    }
